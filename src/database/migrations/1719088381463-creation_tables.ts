...
export class CreationTables1719088381463 implements MigrationInterface {
    name = 'CreationTables1719088381463'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "sale" ("id" SERIAL NOT NULL, "quantity" integer NOT NULL, "saleDate" TIMESTAMP NOT NULL DEFAULT now(), "productId" integer, "userId" integer, CONSTRAINT "PK_d03891c457cbcd22974732b5de2" PRIMARY KEY ("id"))`);
